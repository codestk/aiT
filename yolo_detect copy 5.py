...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.worker = None
        self.current_pixmap = None # ADDED: ตัวแปรสำหรับเก็บเฟรมภาพล่าสุด
        ...
        self.capture_button = QPushButton("Capture Frame") # ADDED: ปุ่ม Capture
        self.stop_button.setEnabled(False)
        self.capture_button.setEnabled(False) # ADDED: ปิดการใช้งานปุ่ม Capture ในตอนแรก
        ...
        button_layout.addWidget(self.capture_button) # ADDED: เพิ่มปุ่ม Capture เข้าไปใน Layout
        ...
        self.capture_button.clicked.connect(self.capture_frame) # ADDED: เชื่อม Signal ของปุ่ม Capture
    ...
    def start_detection(self):
        ...
        if not is_image:
            ...
            self.capture_button.setEnabled(True) # MODIFIED: เปิดใช้งานปุ่ม Capture เมื่อเป็นวิดีโอ
    ...
    def stop_detection(self):
        ...
        if self.worker:
            self.worker.stop()
        self.stop_button.setEnabled(False)
        self.capture_button.setEnabled(False) # MODIFIED: ปิดใช้งานปุ่ม Capture เมื่อหยุด
    ...
    def detection_finished(self):
        ...
        self.stop_button.setEnabled(False)
        self.capture_button.setEnabled(False) # MODIFIED: ปิดใช้งานปุ่ม Capture เมื่อจบ
        self.start_button.setEnabled(True)

    def update_image(self, pixmap):
        self.current_pixmap = pixmap # ADDED: อัปเดตเฟรมภาพล่าสุด
    ...
    # ADDED: ฟังก์ชันใหม่สำหรับบันทึกภาพ
