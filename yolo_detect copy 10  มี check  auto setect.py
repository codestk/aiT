...
from PyQt6.QtWidgets import (QApplication, QMainWindow, QWidget, QLabel, QPushButton, 
                             ...
                             QLineEdit, QFileDialog, QMessageBox, QCheckBox) # ADDED: QCheckBox
...
class Worker(QThread):
    ...
    # MODIFIED: เพิ่ม autosave_enabled
    def __init__(self, model_path, source, initial_thresh, is_image_source, autosave_enabled):
        ...
        self.autosave_enabled = autosave_enabled # ADDED
    ...
    def process_single_image(self, model, labels):
        ...
        # MODIFIED: ตรวจสอบ Checkbox ก่อนบันทึก
        if object_found and self.autosave_enabled:
            base, ext = os.path.splitext(self.source)
            # เปลี่ยนชื่อไฟล์ output เพื่อไม่ให้สับสนกับการบันทึกอัตโนมัติ
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # ADDED: Checkbox for auto-saving
        ...
        control_layout.addWidget(self.autosave_checkbox, 2, 3) # ADDED: Checkbox to layout
    ...
    def start_detection(self):
        ...
        autosave_enabled = self.autosave_checkbox.isChecked() # ADDED
        ...
        # MODIFIED: Pass autosave state to worker
    ...
    def closeEvent(self, event):
        ...
        self.config['autosave'] = self.autosave_checkbox.isChecked() # ADDED
