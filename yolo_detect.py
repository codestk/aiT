...
class Worker(QThread):
    ...
    # MODIFIED: เพิ่ม beep_enabled
    def __init__(self, model_path, source, initial_thresh, is_image_source, autosave_enabled, target_fps, save_original_enabled, beep_enabled):
        super().__init__()
        ...
        self.beep_enabled = beep_enabled # ADDED
...
class MainWindow(QMainWindow):
    ...
    def start_detection(self):
        ...
        # MODIFIED: Pass beep_enabled to worker
        self.worker = Worker(model_path, source, threshold, is_image, autosave_enabled, target_fps, save_original_enabled, beep_enabled)
