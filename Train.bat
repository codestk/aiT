...
rem yolo detect train data=data.yaml model=yolov8s.pt epochs=200 imgsz=640 
yolo detect train data=data.yaml model=yolo11s.pt epochs=200    imgsz=960   batch=2
